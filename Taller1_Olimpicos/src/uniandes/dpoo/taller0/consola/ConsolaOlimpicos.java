...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("6. Consultar el país que representa un atleta");
	...
	/**
	 * Consulta el país que representa un atleta, dado su nombre.
	 */
	private void ejecutarConsultarPaisAtleta()
	{
		System.out.println("\n" + "Consultar país de un atleta" + "\n");
		
		String nombre = input("Ingrese el nombre del atleta a consultar");
		String pais = calculadora.consultarPaisAtleta(nombre);
		if (pais == null)
		{
			System.out.println("No existe un atleta registrado con dicho nombre.");
		}
		else
		{
			System.out.println("El atleta "+ nombre + " representa al país de " + pais + ".");
		}
	}
	...
	private void ejecutarCargarAtletas()
	{
		...
		try
		{
			calculadora = LoaderOlimpicos.cargarArchivo("./data/" + archivo + ".csv");
